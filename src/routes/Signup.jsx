...
const Signup = () => {
    return (
        <div className='flex items-center justify-center bg-[#204E51] h-[100vh] px-[20px]'>
          <div className='h-[70%] bg-white w-[100%] max-w-[650px]  rounded-[20px] px-[55px] py-[38px]'>
            <div>
           < h1 className='text-[70px] text-[#204e51] font-semibold'>Login</h1>
            ...
            <input type='text' placeholder='Full Name' className='border border-black rounded-[20px] h-[60px] w-full px-[25px] text-[15px] text-black'/>
                <input type='email' placeholder='Email' className='border border-black rounded-[20px] h-[60px] w-full px-[25px] text-[15px] text-black'/>
                <input type='password' placeholder='Password' className='border border-black rounded-[20px] h-[60px] w-full px-[25px] text-[15px] text-black'/>
            </div>
