...
const Home = () => {
  return (
    <div className=''>
      ...
      <div className='h-[100vh]  justify-center flex flex-col   opacity-2 backdrop-blur-lg relative ' style={{ backgroundImage: `url('/img/bg.png')`, backgroundSize: 'cover' }}  >
      ...
      <div className='h-[100vh] flex items-center justify-center  max-[1331px]:flex-col  gap-[4rem] max-[1331px]:mx-[0px] '>
        ...
        <h1 className='text-[4rem] text-[#204e51] font-bold justify-start mt-[25px] max-md:text-[3rem] '>Our Product</h1>
        <div className='max-w-[660px] w-[100%] font-normal text-[1.5rem] max-[1331px]:text-[20px] flex-shrink max-md:text-[1rem] '><p>Tailored for maximum crop yield, our system is meticulously designed to optimize agricultural output through strategic and data-driven 
        ...
        <div className='h-[550px]  rounded-[25px] flex-shrink  max-w-[545px] w-[100%]' style={{ backgroundImage: `url('/img/img.png')`, backgroundSize: 'cover' }}  ></div>
      </div>
      <div className='h-auto justify-center flex mt-[20px] '>
        <div className='flex items-center flex-col'>
        <h1 className='text-[#204E51] text-[72px] font-bold max-[745px]:text-[50px] mx-[20px]'>Our Awesome Features</h1>
        <p className=' font-light text-[20px] mt-[10px] max-[745px]:text-[18px] max-[745px]:w-[80%] mb-[20px]'>Li Europan lingues es membres del sam familie. Lor separat existentie es un myth Por scientie, musica.</p>
        <div>
...
<div className="max-[1245px]:grid max-[1245px]:grid-rows-2 max-[1245px]:grid-flow-col flex max-[645px]:grid-rows-4 gap-5">
    {cropData.map((crop, index) => (
      <div key={index} className='bg-white rounded-[17px] min-w-[300px] text-center border px-[25px] py-[20px] mt-[0px] mr-3 flex items-center justify-center flex-col'>
      <img src={require(`../assets/${crop.Image}`)} alt="imawdcw"/>
        <h1 className='text-[18px] text-[#204e51] font-medium py-[20px]'>{crop.title}</h1>
        <p className='text-[15px] font-normal'>{crop.description}</p>
      </div>
    ))}
  </div>
       ...
       <div className='text[#204e51] underline flex items-center justify-center mt-[100px] mb-[50px]'> Learn More</div>
        </div>
      
        
      </div>
      <div className='h-[100vh] '>
        <div className='h-[688px] w-full  px-[150px] py-[10rem] max-[1331px]:px-[120px] max-[731px]:px-[2rem] justify-between text-white flex flex-col' style={{ backgroundImage: `url('/img/img1.png')`, backgroundSize: 'cover' }}>
          <h1 className='text-[4rem] font-bold  max-md:text-[3rem]'> Farming Meets <br/>Technology</h1>
          <h1 className='text-[4rem] font-semibold max-md:text-[3rem] '>32°C Mostly sunny</h1>
          <div>
          <div className='flex items-center justify-start gap-[4rem] mt-[30px] max-[1331px]:mt-[30px] max-md:gap-[2rem]'>
      <Link to="/login">
...
<path d="M12.9366 1L19.5656 8.83208L12.9366 16.6642M1 8.83208H19.3799" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div className='h-[550px] max-w-[545px] w-[100%] rounded-[25px]  flex-shrink ' style={{ backgroundImage: `url('/img/img.png')`, backgroundSize: 'cover' }}></div>
        </div>
